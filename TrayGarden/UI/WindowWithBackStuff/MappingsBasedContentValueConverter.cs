    ...
    public class MappingsBasedContentValueConverter : IMultiValueConverter
    {
        public virtual object Convert(object[] value, Type targetType, object parameter, CultureInfo culture)
        {
           // return new TextBox(){Text = value[0].ToString()};
            ...
            var mappingsSource = value[1] as IContentValueConverterMappingsSource;
            ...
            var mapping = mappings.FirstOrDefault(x => x.AcceptableViewModelType.IsAssignableFrom(valueType));
