...
namespace TrayGarden.Services.PlantServices.UserNotifications.Core.Configuration
{
  public class TimeSpanSettingMediator:BaseSettingMediator
  {
    ...
    public TimeSpan Value
    {
      ...
      set { SettingsBox.SetInt(Key, value.Milliseconds); }
    }

    public TimeSpanSettingMediator([NotNull] string key, int defaultMilliseconds, [NotNull] Func<ISettingsBox> settingsBoxResolver) : base(key, settingsBoxResolver)
    {
