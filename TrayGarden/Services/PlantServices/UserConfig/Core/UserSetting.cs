  ...
  public class UserSetting : IUserSettingMaster
  {
    ...
    public virtual int IntValue
    {
      ...
      set
      {
        ...
        _intValue = value;
        StoreValueInSettingsStorage(value, (name, valueToSave, box) => box.SetInt(name, valueToSave));
    ...
    public virtual bool BoolValue
    {
      ...
      set
      {
        ...
        var beforeState = GetSnapshot();
        _boolValue = value;
        StoreValueInSettingsStorage(value, (name, valueToSave, box) => box.SetBool(name, valueToSave));
        OnChanged(beforeState, this);
      }
    }
    ...
    public virtual double DoubleValue
    {
      ...
      {
        AssertInitialized();
        if (ValueType != UserSettingValueType.Double)
          HandleWrongTypeAssigning();
        var beforeState = GetSnapshot();
        _doubleValue = value;
        StoreValueInSettingsStorage(value, (name, valueToSave, box) => box.SetDouble(name, valueToSave));
        OnChanged(beforeState, this);
      }
    }
    ...
    public virtual string StringValue
    {
      ...
      set
      {
        ...
        var beforeState = GetSnapshot();
        _stringValue = value;
        StoreValueInSettingsStorage(value, (name, valueToSave, box) => box.SetString(name, valueToSave));
        OnChanged(beforeState, this);
      }
    }
    ...
    public virtual string StringOptionValue
    {
      ...
      set
      {
        ...
        StoreValueInSettingsStorage(_stringOptionValue, (name, valueToSave, box) => box.SetString(name, valueToSave));
        OnChanged(beforeState, this);
      }
    }
    ...
    protected virtual void SetInitialSettingValue(IUserSettingMetadata metadata, ISettingsBox settingsBox)
    {
      ...
      {
        double newValue;
        if (settingsBox.TryGetDouble(metadata.Name, out newValue))
        {
    ...
    protected virtual void StoreValueInSettingsStorage<T>(T value, Action<string, T, ISettingsBox> saver)
    {
      saver(Name, value, SettingsBox);
    }
    ...
    protected virtual void ResetToDefaultInternal(IUserSettingMetadata metadata)
    {
      ...
      {
        double newValue;
        if (double.TryParse(metadata.DefaultValue, out newValue))
        {
          _doubleValue = newValue;
          return;
        }
