...
{
  public class UserSettingStringPlayer : ConfigurationAwarePlayer
  {
    #region Constructors and Destructors

    public UserSettingStringPlayer([NotNull] IStringUserSetting userSetting)
    ...
    public IStringUserSetting UserSetting { get; set; }
