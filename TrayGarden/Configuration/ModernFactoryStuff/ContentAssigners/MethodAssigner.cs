    ...
    public class MethodAssigner : IContentAssigner
    {
        ...
        protected virtual MethodInfo ResolveMethodInfo(XmlNode contentNode, object instance, Type instanceType)
        {
            ...
            else
            {
                ...
                {
                    if (methodInfo.Name.Equals(nodeName, StringComparison.OrdinalIgnoreCase) &&
                        methodInfo.GetParameters().Length == paramsCount)
                    {
        ...
        protected virtual object[] GetArgValues(XmlNode contentNode, Type[] argTypes,
                                                Func<Type, IParcer> valueParcerResolver)
        {
